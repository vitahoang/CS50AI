...
class MinesweeperAI():
    ...
    def make_random_move(self):
        ...
        """
        all_cells = set(itertools.product(
    ...
    def update_knowledge(self):
        """ Updates the AI's knowledge base by marking known mines and safes,
            and inferring new sentences from existing knowledge.
        """
        updated = True
        while updated:
            updated = False
            ...
            for sentence in self.knowledge:
                ...
                all_safes |= sentence.known_safes()
