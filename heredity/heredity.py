...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    """
    joint_probability = 1
    # Loop over each person to calculate their individual probability
    for person in people:
        ...
        if mother is None and father is None:
            ...
            # Calculate mother and father passing probabilities
            ...
            if genes == 1:
                gene_prob = mother_prob * \
                    (1 - father_prob) + (1 - mother_prob) * father_prob
